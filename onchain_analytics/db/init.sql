-- ===========================================
-- ACU Token Analytics - Database Initialization
-- ===========================================
...
-- Swaps table (will be converted to hypertable)
...
-- Convert swaps to hypertable (chunk by day)
...
-- Convert transfers to hypertable
